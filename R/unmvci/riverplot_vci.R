...
#'
#' @examples
riverplot_vci <- function(n_patients, title_legend = "Patients", rp_plot_area = 1, report_date = NULL) {
  ...
  #text(1, 0, paste("VCI", lubridate::now()), pos = 4, offset = 1.75, col="black", cex = 0.8)
  ...
  #text(1, 0, paste("VCI", lubridate::now()), pos = 2, offset = 2, col="black", cex = 0.8) # bottom-right
  text(1, 0.93, paste("VCI", report_date), pos = 2, offset = 2, col="black", cex = 0.8) # top-right
